...
Either run ```php composer.phar require soofani/yii2-image-s3 "dev-master"```

or add ```"soofani/yii2-image-s3": "dev-master"``` to the require section of your ```composer.json```
...
'options' => [
    'placeholder' => [
        'type' => soofani\image\Thumbnail::PLACEHOLDER_TYPE_URL,
...
#### Placeholder type
- 1. soofani\image\Thumbnail::PLACEHOLDER_TYPE_JS - holder.js
- 2. soofani\image\Thumbnail::PLACEHOLDER_TYPE_URL - get placeholder by url
- 3. soofani\image\Thumbnail::PLACEHOLDER_TYPE_IMAGINE - create placeholder used Imagine
